...
# Apply
kubectl apply -f k8s
kubectl set image deploymants/client-deployment server=mistydev/multi-client:$SHA
kubectl set image deploymants/server-deployment server=mistydev/multi-server:$SHA
kubectl set image deploymants/worker-deployment server=mistydev/multi-worker:$SHA
